...
struct ContentView: View, EDIFACTReaderDelegate {
  ...
  @State private var schema: String = "/Applications/IPWorks EDI 2024 macOS Edition/demos/EDIFACT Parser/RSSBus_D97A_INVOIC.json"
  @State private var filename: String = "/Applications/IPWorks EDI 2024 macOS Edition/demos/EDIFACT Parser/INVOIC.edi"
