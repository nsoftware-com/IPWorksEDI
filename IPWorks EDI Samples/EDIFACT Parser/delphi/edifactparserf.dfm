object FormEdifactparser: TFormEdifactparser
  ...
  object ibeEDIFACTReader1: TibeEDIFACTReader
    OnEndFunctionalGroup = ibeEDIFACTReader1EndFunctionalGroup
    OnEndInterchange = ibeEDIFACTReader1EndInterchange
    OnEndLoop = ibeEDIFACTReader1EndLoop
    OnEndTransaction = ibeEDIFACTReader1EndTransaction
    OnError = ibeEDIFACTReader1Error
    OnResolveSchema = ibeEDIFACTReader1ResolveSchema
    OnSegment = ibeEDIFACTReader1Segment
    OnStartFunctionalGroup = ibeEDIFACTReader1StartFunctionalGroup
    OnStartInterchange = ibeEDIFACTReader1StartInterchange
    OnStartLoop = ibeEDIFACTReader1StartLoop
    OnStartTransaction = ibeEDIFACTReader1StartTransaction
    OnWarning = ibeEDIFACTReader1Warning
    Left = 560
    Top = 200
  end
  object ibeEDIFACTWriter1: TibeEDIFACTWriter
    Left = 512
    Top = 200
  end
end
