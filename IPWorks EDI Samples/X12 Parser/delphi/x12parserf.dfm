object FormX12parser: TFormX12parser
  ...
  object ibeX12Reader1: TibeX12Reader
    OnEndFunctionalGroup = ibeX12Reader1EndFunctionalGroup
    OnEndInterchange = ibeX12Reader1EndInterchange
    OnEndLoop = ibeX12Reader1EndLoop
    OnEndTransaction = ibeX12Reader1EndTransaction
    OnError = ibeX12Reader1Error
    OnResolveSchema = ibeX12Reader1ResolveSchema
    OnSegment = ibeX12Reader1Segment
    OnStartFunctionalGroup = ibeX12Reader1StartFunctionalGroup
    OnStartInterchange = ibeX12Reader1StartInterchange
    OnStartLoop = ibeX12Reader1StartLoop
    OnStartTransaction = ibeX12Reader1StartTransaction
    OnWarning = ibeX12Reader1Warning
    Left = 560
    Top = 200
  end
  object ibeX12Writer1: TibeX12Writer
    Left = 512
    Top = 200
  end
end
