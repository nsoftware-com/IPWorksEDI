...
struct ContentView: View, X12ReaderDelegate {
  ...
  @State private var schema: String = "/Applications/IPWorks EDI 2024 macOS Edition/demos/X12 Parser/RSSBus_00401_810.json"
  @State private var filename: String = "/Applications/IPWorks EDI 2024 macOS Edition/demos/X12 Parser/x12.txt"
