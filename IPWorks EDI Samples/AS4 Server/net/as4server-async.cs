...
public class as4serverDemo
{
    ...
    public static async Task Main(string[] args)
    {
        try
        {
            ...
            // later
            await as4.Config("ResponseToString=true");
            ...
            while (listener.IsListening)
            {
                ...
                try
                {
                    ...
                    await as4.SetRequestStream(context.Request.InputStream);
                    
                    // Parse the request
                    await as4.ReadRequest();
                    ...
                    if (string.IsNullOrEmpty(as4.AgreementRef) && !string.IsNullOrEmpty(as4.MPC))
                    {
                        switch (as4.MPC)
                        {
                            case "mpc_A":
                                ...
                                await as4.Config("FilenameProperty=FileName");
                    ...
                    string responseHeaders = await as4.Config("ResponseHeaders");
                    string responseBody = await as4.Config("ResponseBody");
                ...
                catch (IPWorksEDIAs4serverException e)
                {
                    Console.WriteLine("IPWorksEDIAs4serverException: " + e.Message);
